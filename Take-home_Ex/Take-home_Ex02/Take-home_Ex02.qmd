...
## **Step 1: Filter links by hscode and year**
...
## {{< fa fish >}}**Fishyness based on Centrality?**

```{r}
top30_centrality <- top30_centrality %>%
  mutate(Betweenness_centrality = transform_variable(Betweenness_centrality),
         Eigenvector_centrality = transform_variable(Eigenvector_centrality),
         PageRank_score = transform_variable(PageRank_score),
         centrality_total = Betweenness_centrality + Eigenvector_centrality + PageRank_score)
...
::: panel-tabset
## **Step 1: Aggregating values by Year**
